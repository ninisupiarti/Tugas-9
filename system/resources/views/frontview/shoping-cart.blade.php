			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Free shipping for standard order over Rp.40.000
					</div>
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="{{url('public')}}/images/item-cart-04.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Sepatu Loafers</td>
									<td class="column-3">Rp.135.000</td>
									<td class="column-4">
									...
									<td class="column-5">Rp.135.000</td>
								</tr>

								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="{{url('public')}}/images/item-cart-05.jpg" alt="IMG">
										</div>
									</td>
									<td class="column-2">Sepatu Song Hye Kyo</td>
									<td class="column-3">Rp.70.000</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
									...
									<td class="column-5">Rp.70.000</td>
								</tr>
							</table>
						</div>
